---
title: "STAT462 - Installing R and R-Studio"
author: "Dr Greatrex, SP25"
format: html
editor: visual
toc: true
toc_float: true
...
[![](Images/01_Installing%20R.png){fig-alt="Installing R and R-Studio" fig-align="right" width="95%"}](https://posit.co/download/rstudio-desktop/#download)
...
[![](Images/02_CranR.png){fig-align="right" width="95%"}](https://cran.rstudio.com/)

[**STEP 3**]{.underline} <br>The setup looks a little different depending on whether you are on a Windows Machine or a Mac:

<details>

`<summary> `{=html} [WINDOWS people]{.underline}, Click the arrow to show your instructions</summary>

![](Images/03_WindowsCran.png){fig-align="right" width="95%"}
...
`<summary> `{=html} [MAC people]{.underline}, Click the arrow to show your instructions</summary>

![](Images/04_CRANR_Mac.png){fig-align="right" width="95%"}
...
![](Images/05_InstallRStudio.png){fig-align="right" width="95%"}
...
![](Images/06_RstudioMac.png){fig-align="right" width="90%"}
